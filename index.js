...
let ACCOUNT_ID_2 = 'a62e740b4d4e6b535df69cfe8';
...
async function sendLocation(level, objectCode, continent, x, y) {
    ...
    fetch("https://api-lok-live.leagueofkingdoms.com/api/chat/new", {
        ...
        "body": `json=%7B%22chatChannel%22%3A2%2C%22chatType%22%3A2%2C%22text%22%3A%22Lv.${level}%3Ffo_${objectCode}%22%2C%22param%22%3A%7B%22loc%22%3A%5B${continent}%2C${x}%2C${y}%5D%7D%7D`,
        "method": "POST",
        "mode": "cors",
        "credentials": "omit"
    });
